...
<body>
    <header class="px-3 pt-3 pb-0">
        <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex align-items-center">
                <img src="https://www.google.com/images/branding/googlelogo/1x/googlelogo_white_background_color_272x92dp.png" alt="google">
                <a class="ms-2" href="">Privacy e Termini</a>
            </div>
            <div><i class="fas fa-bars fa-2x"></i></div>
        </div>
        <nav class="mt-2">
            <ul class="ps-0 d-flex align-items-center">
                <li class="me-2"><a href="">Introduzione</a></li>
                <li class="me-2"><a href="">Norme sulla privacy</a></li>
                <li class="me-2"><a href="">Termini di servizio</a></li>
                <li class="me-2"><a href="">Tecnologie</a></li>
    ...
    <main>
        <?php foreach ($faqs as $faq) { ?>
            <h1 class="my-3 h3"><?= $faq['title'] ?></h1>
            <div><?php foreach ($faq['text'] as $faq_text) {
                        echo $faq_text;
                    } ?></div>
        <?php } ?>
    </main>
